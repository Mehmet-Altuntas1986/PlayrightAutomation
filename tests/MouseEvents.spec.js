...
test('Mouse hover',async ({page})=>{
    ...
    const macbook= await page.locator('//a[normalize-space()="Mac (1)"]');
     ...
     // Mose hover
     await desktops.hover()       //mouse desktop elementinin ustune gelir
     await macbook.hover()        //mouse macbook  elementinin ustune gelir
...
test('Right Click',async ({page})=>{
   ...
   // Wait for the button to be visible on the page
    const button1 = await page.locator('//span[normalize-space()="right click me"]');
    
    // Right-click on the button
    await button.click({ button1: 'right' });
    await page.waitForTimeout(5000) 
